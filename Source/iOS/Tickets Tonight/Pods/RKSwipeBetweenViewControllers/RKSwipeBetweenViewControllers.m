...
-(void)setupSegmentButtons
{
    ...
    if (!buttonText) {
         buttonText = [[NSArray alloc]initWithObjects: @"Recent",@"Favorite",@"Following",@"fourth",@"etc",@"etc",@"etc",@"etc",nil]; //%%%buttontitle
    }
...
-(void)setupSelector
{
    ...
    selectionBar.backgroundColor = [UIColor colorWithRed:0.890 green:0.188 blue:0.157 alpha:1.000]; //%%% sbcolor
    selectionBar.alpha = 0.8; //%%% sbalpha
    [navigationView addSubview:selectionBar];
    
    manualSelectionBar = [[UIView alloc]initWithFrame:selectionBar.frame];
    manualSelectionBar.backgroundColor = [UIColor colorWithRed:0.890 green:0.188 blue:0.157 alpha:1.000]; //%%% sbcolor (moving)
